            ...
            <form action="{{ route('materia_primas.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="codigo_sku" class="form-control" value="{{ old('codigo_sku') }}">
                    </div>
                    <div class="col-md-3 mb-3">
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" step="0.01" min="0" name="custo_unitario" class="form-control" value="{{ old('custo_unitario', 0) }}" required>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Estoque Atual *</label>
                        <input type="number" step="0.01" min="0" name="estoque_atual" id="estoque_atual" class="form-control" value="{{ old('estoque_atual', 0) }}" required>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Estoque Mínimo</label>
                        <input type="number" step="0.01" min="0" name="estoque_minimo" id="estoque_minimo" class="form-control" value="{{ old('estoque_minimo', 0) }}">
                    </div>
                    <div class="col-md-3 mb-3">
