    ...
    <div class="row">
        <div class="col-md-7">
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white"><h5 class="mb-0">Dados do Serviço</h5></div>
                <div class="card-body">
                    <form action="{{ route('servicos.update', $servico) }}" method="POST">
                        ...
                        <div class="text-end mt-3">
                            <button class="btn btn-primary">Atualizar Serviço</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="col-md-5">
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('ficha.servico.store', $servico) }}" method="POST" class="mb-4">
                        @csrf
                        <div class="mb-2">
                    ...
                    <ul class="list-group list-group-flush">
                        @forelse($servico->fichaTecnicas as $ficha)
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <div>
                                    <strong>{{ $ficha->materiaPrima->nome }}</strong><br>
                                    <small class="text-muted">Gasto: {{ number_format($ficha->quantidade, 3, ',', '.') }} {{ $ficha->materiaPrima->unidade_medida }} / serviço</small>
                                </div>
                        ...
                        @empty
                            <li class="list-group-item px-0 text-muted text-center py-3">
                                ...
                                <small>Nenhum estoque será abatido.</small>
                            </li>
                        @endforelse
                    </ul>
                </div>
